...
atoo(const char *s)
{
    ...
    int n, sign;
    n = 0;
    3e90:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (*s == ' ')
    3e97:	eb 04                	jmp    3e9d <atoo+0x13>
        s++;
...
atoo(const char *s)
{
    ...
    3ea0:	0f b6 00             	movzbl (%eax),%eax
    3ea3:	3c 20                	cmp    $0x20,%al
    3ea5:	74 f2                	je     3e99 <atoo+0xf>
        s++;
    sign = (*s == '-') ? -1 : 1;
    3ea7:	8b 45 08             	mov    0x8(%ebp),%eax
    3eaa:	0f b6 00             	movzbl (%eax),%eax
    3ead:	3c 2d                	cmp    $0x2d,%al
    3eaf:	75 07                	jne    3eb8 <atoo+0x2e>
    3eb1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3eb6:	eb 05                	jmp    3ebd <atoo+0x33>
    3eb8:	b8 01 00 00 00       	mov    $0x1,%eax
    3ebd:	89 45 f8             	mov    %eax,-0x8(%ebp)
    if (*s == '+' || *s == '-')
    3ec0:	8b 45 08             	mov    0x8(%ebp),%eax
    3ec3:	0f b6 00             	movzbl (%eax),%eax
    3ec6:	3c 2b                	cmp    $0x2b,%al
    3ec8:	74 0a                	je     3ed4 <atoo+0x4a>
    3eca:	8b 45 08             	mov    0x8(%ebp),%eax
    3ecd:	0f b6 00             	movzbl (%eax),%eax
    3ed0:	3c 2d                	cmp    $0x2d,%al
    3ed2:	75 27                	jne    3efb <atoo+0x71>
        s++;
    3ed4:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while ('0' <= *s && *s <= '7')
    3ed8:	eb 21                	jmp    3efb <atoo+0x71>
        n = n*8 + *s++ - '0';
    3eda:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3edd:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
    3ee4:	8b 45 08             	mov    0x8(%ebp),%eax
    3ee7:	8d 50 01             	lea    0x1(%eax),%edx
    3eea:	89 55 08             	mov    %edx,0x8(%ebp)
    3eed:	0f b6 00             	movzbl (%eax),%eax
    3ef0:	0f be c0             	movsbl %al,%eax
    3ef3:	01 c8                	add    %ecx,%eax
    3ef5:	83 e8 30             	sub    $0x30,%eax
    3ef8:	89 45 fc             	mov    %eax,-0x4(%ebp)
    while (*s == ' ')
        s++;
    sign = (*s == '-') ? -1 : 1;
    if (*s == '+' || *s == '-')
    ...
    3efe:	0f b6 00             	movzbl (%eax),%eax
    3f01:	3c 2f                	cmp    $0x2f,%al
    3f03:	7e 0a                	jle    3f0f <atoo+0x85>
    3f05:	8b 45 08             	mov    0x8(%ebp),%eax
    3f08:	0f b6 00             	movzbl (%eax),%eax
    3f0b:	3c 37                	cmp    $0x37,%al
    3f0d:	7e cb                	jle    3eda <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
    3f0f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3f12:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
    3f16:	c9                   	leave  
    3f17:	c3                   	ret    
...
memmove(void *vdst, void *vsrc, int n)
{
  ...
  while(n-- > 0)
    3f2a:	eb 17                	jmp    3f43 <memmove+0x2b>
    *dst++ = *src++;
    3f2c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f2f:	8d 50 01             	lea    0x1(%eax),%edx
    3f32:	89 55 fc             	mov    %edx,-0x4(%ebp)
    3f35:	8b 55 f8             	mov    -0x8(%ebp),%edx
    3f38:	8d 4a 01             	lea    0x1(%edx),%ecx
    3f3b:	89 4d f8             	mov    %ecx,-0x8(%ebp)
    3f3e:	0f b6 12             	movzbl (%edx),%edx
    3f41:	88 10                	mov    %dl,(%eax)
{
  char *dst, *src;
  ...
  src = vsrc;
  while(n-- > 0)
    3f43:	8b 45 10             	mov    0x10(%ebp),%eax
    3f46:	8d 50 ff             	lea    -0x1(%eax),%edx
    3f49:	89 55 10             	mov    %edx,0x10(%ebp)
    3f4c:	85 c0                	test   %eax,%eax
    3f4e:	7f dc                	jg     3f2c <memmove+0x14>
    *dst++ = *src++;
  return vdst;
