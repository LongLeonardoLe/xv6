...
atoo(const char *s)
{
 ...
 31b:	7e 0a                	jle    327 <atoo+0x85>
 31d:	8b 45 08             	mov    0x8(%ebp),%eax
 320:	0f b6 00             	movzbl (%eax),%eax
 323:	3c 37                	cmp    $0x37,%al
 325:	7e cb                	jle    2f2 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 327:	8b 45 f8             	mov    -0x8(%ebp),%eax
 32a:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 32e:	c9                   	leave  
 32f:	c3                   	ret    
