...
atoo(const char *s)
{
 ...
 24f:	3c 20                	cmp    $0x20,%al
 251:	74 f2                	je     245 <atoo+0xf>
        s++;
    sign = (*s == '-') ? -1 : 1;
 253:	8b 45 08             	mov    0x8(%ebp),%eax
 256:	0f b6 00             	movzbl (%eax),%eax
 259:	3c 2d                	cmp    $0x2d,%al
 25b:	75 07                	jne    264 <atoo+0x2e>
 25d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 262:	eb 05                	jmp    269 <atoo+0x33>
 264:	b8 01 00 00 00       	mov    $0x1,%eax
 269:	89 45 f8             	mov    %eax,-0x8(%ebp)
    if (*s == '+' || *s == '-')
 26c:	8b 45 08             	mov    0x8(%ebp),%eax
 26f:	0f b6 00             	movzbl (%eax),%eax
 272:	3c 2b                	cmp    $0x2b,%al
 274:	74 0a                	je     280 <atoo+0x4a>
 276:	8b 45 08             	mov    0x8(%ebp),%eax
 279:	0f b6 00             	movzbl (%eax),%eax
 27c:	3c 2d                	cmp    $0x2d,%al
 27e:	75 27                	jne    2a7 <atoo+0x71>
        s++;
 280:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while ('0' <= *s && *s <= '7')
 284:	eb 21                	jmp    2a7 <atoo+0x71>
        n = n*8 + *s++ - '0';
 286:	8b 45 fc             	mov    -0x4(%ebp),%eax
 289:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
 ...
 2af:	7e 0a                	jle    2bb <atoo+0x85>
 2b1:	8b 45 08             	mov    0x8(%ebp),%eax
 2b4:	0f b6 00             	movzbl (%eax),%eax
 2b7:	3c 37                	cmp    $0x37,%al
 2b9:	7e cb                	jle    286 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 2bb:	8b 45 f8             	mov    -0x8(%ebp),%eax
 2be:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 2c2:	c9                   	leave  
 2c3:	c3                   	ret    
...
memmove(void *vdst, void *vsrc, int n)
{
 ...
 2d3:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0)
 2d6:	eb 17                	jmp    2ef <memmove+0x2b>
    *dst++ = *src++;
 2d8:	8b 45 fc             	mov    -0x4(%ebp),%eax
 2db:	8d 50 01             	lea    0x1(%eax),%edx
 2de:	89 55 fc             	mov    %edx,-0x4(%ebp)
 2e1:	8b 55 f8             	mov    -0x8(%ebp),%edx
 2e4:	8d 4a 01             	lea    0x1(%edx),%ecx
 2e7:	89 4d f8             	mov    %ecx,-0x8(%ebp)
 ...
 2ed:	88 10                	mov    %dl,(%eax)
{
 ...
 2f2:	8d 50 ff             	lea    -0x1(%eax),%edx
 2f5:	89 55 10             	mov    %edx,0x10(%ebp)
 2f8:	85 c0                	test   %eax,%eax
 2fa:	7f dc                	jg     2d8 <memmove+0x14>
    *dst++ = *src++;
  return vdst;
