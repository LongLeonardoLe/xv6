...
grep(char *pattern, int fd)
{
  ...
  c0:	e8 11 05 00 00       	call   5d6 <memmove>
...
atoo(const char *s)
{
 ...
 561:	3c 20                	cmp    $0x20,%al
 563:	74 f2                	je     557 <atoo+0xf>
        s++;
    sign = (*s == '-') ? -1 : 1;
 565:	8b 45 08             	mov    0x8(%ebp),%eax
 568:	0f b6 00             	movzbl (%eax),%eax
 56b:	3c 2d                	cmp    $0x2d,%al
 56d:	75 07                	jne    576 <atoo+0x2e>
 56f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 574:	eb 05                	jmp    57b <atoo+0x33>
 ...
 5bf:	3c 2f                	cmp    $0x2f,%al
 5c1:	7e 0a                	jle    5cd <atoo+0x85>
 5c3:	8b 45 08             	mov    0x8(%ebp),%eax
 5c6:	0f b6 00             	movzbl (%eax),%eax
 5c9:	3c 37                	cmp    $0x37,%al
 5cb:	7e cb                	jle    598 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 5cd:	8b 45 f8             	mov    -0x8(%ebp),%eax
 5d0:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 5d4:	c9                   	leave  
 5d5:	c3                   	ret    
