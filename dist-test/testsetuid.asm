...
atoo(const char *s)
{
 ...
 2bc:	3c 2f                	cmp    $0x2f,%al
 2be:	7e 0a                	jle    2ca <atoo+0x85>
 2c0:	8b 45 08             	mov    0x8(%ebp),%eax
 2c3:	0f b6 00             	movzbl (%eax),%eax
 2c6:	3c 37                	cmp    $0x37,%al
 2c8:	7e cb                	jle    295 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 2ca:	8b 45 f8             	mov    -0x8(%ebp),%eax
 2cd:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 2d1:	c9                   	leave  
 2d2:	c3                   	ret    
