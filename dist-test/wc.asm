...
atoo(const char *s)
{
 ...
 3d2:	83 ec 10             	sub    $0x10,%esp
    int n, sign;
    n = 0;
 3d5:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (*s == ' ')
 3dc:	eb 04                	jmp    3e2 <atoo+0x13>
        s++;
...
atoo(const char *s)
{
 ...
 446:	3c 2f                	cmp    $0x2f,%al
 448:	7e 0a                	jle    454 <atoo+0x85>
 44a:	8b 45 08             	mov    0x8(%ebp),%eax
 44d:	0f b6 00             	movzbl (%eax),%eax
 450:	3c 37                	cmp    $0x37,%al
 452:	7e cb                	jle    41f <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 454:	8b 45 f8             	mov    -0x8(%ebp),%eax
 457:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 45b:	c9                   	leave  
 45c:	c3                   	ret    
...
memmove(void *vdst, void *vsrc, int n)
{
 ...
 46c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0)
 46f:	eb 17                	jmp    488 <memmove+0x2b>
    *dst++ = *src++;
 471:	8b 45 fc             	mov    -0x4(%ebp),%eax
 474:	8d 50 01             	lea    0x1(%eax),%edx
 477:	89 55 fc             	mov    %edx,-0x4(%ebp)
 47a:	8b 55 f8             	mov    -0x8(%ebp),%edx
 47d:	8d 4a 01             	lea    0x1(%edx),%ecx
 480:	89 4d f8             	mov    %ecx,-0x8(%ebp)
 ...
 486:	88 10                	mov    %dl,(%eax)
{
 ...
 48b:	8d 50 ff             	lea    -0x1(%eax),%edx
 48e:	89 55 10             	mov    %edx,0x10(%ebp)
 491:	85 c0                	test   %eax,%eax
 493:	7f dc                	jg     471 <memmove+0x14>
    *dst++ = *src++;
  return vdst;
