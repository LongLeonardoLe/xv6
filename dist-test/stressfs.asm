...
atoo(const char *s)
{
 ...
 3a2:	74 0a                	je     3ae <atoo+0x4a>
 3a4:	8b 45 08             	mov    0x8(%ebp),%eax
 3a7:	0f b6 00             	movzbl (%eax),%eax
 3aa:	3c 2d                	cmp    $0x2d,%al
 3ac:	75 27                	jne    3d5 <atoo+0x71>
        s++;
 3ae:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while ('0' <= *s && *s <= '7')
 3b2:	eb 21                	jmp    3d5 <atoo+0x71>
        n = n*8 + *s++ - '0';
 3b4:	8b 45 fc             	mov    -0x4(%ebp),%eax
 3b7:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
 ...
 3dd:	7e 0a                	jle    3e9 <atoo+0x85>
 3df:	8b 45 08             	mov    0x8(%ebp),%eax
 3e2:	0f b6 00             	movzbl (%eax),%eax
 3e5:	3c 37                	cmp    $0x37,%al
 3e7:	7e cb                	jle    3b4 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
