...
atoo(const char *s)
{
 ...
 33a:	3c 20                	cmp    $0x20,%al
 33c:	74 f2                	je     330 <atoo+0xf>
        s++;
    sign = (*s == '-') ? -1 : 1;
 33e:	8b 45 08             	mov    0x8(%ebp),%eax
 341:	0f b6 00             	movzbl (%eax),%eax
 344:	3c 2d                	cmp    $0x2d,%al
 346:	75 07                	jne    34f <atoo+0x2e>
 348:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 34d:	eb 05                	jmp    354 <atoo+0x33>
 34f:	b8 01 00 00 00       	mov    $0x1,%eax
 354:	89 45 f8             	mov    %eax,-0x8(%ebp)
    if (*s == '+' || *s == '-')
 357:	8b 45 08             	mov    0x8(%ebp),%eax
 35a:	0f b6 00             	movzbl (%eax),%eax
 35d:	3c 2b                	cmp    $0x2b,%al
 35f:	74 0a                	je     36b <atoo+0x4a>
 361:	8b 45 08             	mov    0x8(%ebp),%eax
 364:	0f b6 00             	movzbl (%eax),%eax
 367:	3c 2d                	cmp    $0x2d,%al
 369:	75 27                	jne    392 <atoo+0x71>
        s++;
 36b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while ('0' <= *s && *s <= '7')
 36f:	eb 21                	jmp    392 <atoo+0x71>
        n = n*8 + *s++ - '0';
 371:	8b 45 fc             	mov    -0x4(%ebp),%eax
 374:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
 37b:	8b 45 08             	mov    0x8(%ebp),%eax
 37e:	8d 50 01             	lea    0x1(%eax),%edx
 381:	89 55 08             	mov    %edx,0x8(%ebp)
 384:	0f b6 00             	movzbl (%eax),%eax
 387:	0f be c0             	movsbl %al,%eax
 38a:	01 c8                	add    %ecx,%eax
 38c:	83 e8 30             	sub    $0x30,%eax
 ...
 398:	3c 2f                	cmp    $0x2f,%al
 39a:	7e 0a                	jle    3a6 <atoo+0x85>
 39c:	8b 45 08             	mov    0x8(%ebp),%eax
 39f:	0f b6 00             	movzbl (%eax),%eax
 3a2:	3c 37                	cmp    $0x37,%al
 3a4:	7e cb                	jle    371 <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 3a6:	8b 45 f8             	mov    -0x8(%ebp),%eax
 3a9:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 3ad:	c9                   	leave  
 3ae:	c3                   	ret    
