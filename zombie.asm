...
atoo(const char *s)
{
 ...
 27c:	74 0a                	je     288 <atoo+0x4a>
 27e:	8b 45 08             	mov    0x8(%ebp),%eax
 281:	0f b6 00             	movzbl (%eax),%eax
 284:	3c 2d                	cmp    $0x2d,%al
 286:	75 27                	jne    2af <atoo+0x71>
        s++;
 288:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    while ('0' <= *s && *s <= '7')
 28c:	eb 21                	jmp    2af <atoo+0x71>
        n = n*8 + *s++ - '0';
 28e:	8b 45 fc             	mov    -0x4(%ebp),%eax
 291:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
 ...
 2b7:	7e 0a                	jle    2c3 <atoo+0x85>
 2b9:	8b 45 08             	mov    0x8(%ebp),%eax
 2bc:	0f b6 00             	movzbl (%eax),%eax
 2bf:	3c 37                	cmp    $0x37,%al
 2c1:	7e cb                	jle    28e <atoo+0x50>
        n = n*8 + *s++ - '0';
    return sign*n;
 2c3:	8b 45 f8             	mov    -0x8(%ebp),%eax
 2c6:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 2ca:	c9                   	leave  
 2cb:	c3                   	ret    
